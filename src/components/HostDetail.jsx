...
function App() {
  return (
    <div className="bg-stone-200 flex flex-col md:flex-row  h-[27rem] rounded-[20px] my-6 ">
      <div className="ml-10 flex flex-row ">
        <div className="basis-1/3">
              ...
              <div className="flex flex-col ml-[1rem] mt-[1.4rem] justify-items-center gap-[1rem]">
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-row items-center">
                    <div className="flex flex-row">
                      <div className="text-lg font-bold">1160</div>{' '}
                      <div className="font-bold text-[0.6rem]  pl-[0.2rem] pt-[0.8rem]">개</div>
                    </div>
                    <hr />
                  </div>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-row">
                    ...
                    <div className="font-bold text-[0.6rem] pl-[0.2rem] pt-[0.6rem]">년</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="ml-[4rem] mt-[1.9rem] rounded ">
            ...
            <div className="mt-[1.3rem] text-left text-xs">
              ONDA는 다양한 숙박업소분들과 함께 일하는 팀입니다. 한국의 각 지역의 멋진 숙박업소를 찾아 고객님께...
            </div>
        ...
        <div className="ml-[3rem]">
          <div className=" text-left p-[2.3rem] ">
            ...
            <button className="w-[13rem] h-[3rem] rounded-[5px] text-sm font-bold bg-black text-white transition-all duration-200 ease-in-out">
              호스트에게 메시지 보내기
            </button>
