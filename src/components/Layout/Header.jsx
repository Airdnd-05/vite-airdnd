...
function Header() {
  return (
    <>
      <header className="w-full h-[80px] grid grid-cols-3 bg-white border-b border-solid border-gray-200 px-20">
        <div className="flex">
          <img className="w-max" src={HeaderLogo} />
        </div>
        <div className="flex items-center justify-center">
          <div className="bg-white rounded-full shadow border border-solid border-gray-200 flex justify-center items-center gap-1 p-1 h-[50px]">
        ...
        <div className="flex flex-row justify-end">
          <div className="flex flex-row items-center">
            <p className="mr-7">당신의 공간을 에어비앤비하세요.</p>
            <img src={HeaderWorld} />
          </div>
          <div className="flex flex-column items-center ml-7">
